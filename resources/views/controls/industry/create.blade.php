...
<div class="row d-flex justify-content-center mb-4">
    <div class="col-md-8 col-sm-12 col-lg-6">
     <div class="card shadow border-left-success">
         ...
         <span class="text-center">Add Industry <i class="fas fa-industry text-success"></i></span>
         </div>
         <div class="card-body">
            @if ($errors->any())
         ...
         <form method="POST" action="{{route('industry.store')}}">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Name of industry" name="name" required>
                </div>
