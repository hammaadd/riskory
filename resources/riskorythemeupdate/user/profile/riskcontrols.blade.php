                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-6 col-lg-3 px-0">
                                    <button class="bg-red color-w font-12 border-0 br-12 py-2 px-3 font-eb" onclick="parent.location='{{route('add.benchmark',$rc)}}'">Add Benchmark</button>
                                <p class="font-e font-14 text-underl pt-3"><a href="{{route('rc.show',$rc->id)}}" class="color-r">Click for more Info</a></p>
                                </div>
