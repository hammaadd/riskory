    ...
    <div class="sect--title pl-3 pl-md-5">
        <div class="row mb-4 mb-xl-5">
            <div class="col-lg-auto col-12 px-0 pr-lg-3 sect--title__col">
                <p class="bg-lblue font-eb d-sm-inline-block font-18 ml-md-3 py-2 pl-3 pl-md-5 pr-5 mb-0 rounded-right-xl shadow-sm"><i class="fas fa-bell color-r"></i>&nbsp;&nbsp;Old Notifications</p>
            </div>
        </div>
    </div>
