    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-6 mb-2">
            {{-- <div class="row align-items-center bg-lgray box-shadow py-2"> --}}
                <div class="div-hover">
                    <p class="p-style mb-0 d-inline mr-3"><a href="{{route('byControl',['control'=>$dat,'type'=>$dat->type])}}" data-toggle="tooltip" data-placement="top" title="">{{Str::limit($dat->name,30)}}</a> ({{$dat->rccontrols->whereNotIn('rc.status',['P','R'])->count()}})</p>
