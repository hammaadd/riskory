...
@section('content')
        ...
        <div class="pl-0 col-12 col-md-9 py-5 pr-0 pr-md-3 pr-lg-5">
            ...
            <div class="row mx-0 mb-4 my-xl-5 align-items-lg-center">
                ...
                <div class="col-lg-auto col-12 mt-3 mt-lg-0 pl-md-5 pl-lg-3 text-muted">
                ...
                <div class="col-lg-auto col-12 mt-3 mt-lg-0 pl-md-5 pl-lg-3 ml-auto">
            ...
            <div class="row mx-0 mt-5 mb-4 mb-xl-5 align-items-lg-center">
                <div class="col-lg-auto col-12 pl-0">
            ...
            <div class="row mx-0 mt-5 mb-4 mb-xl-5 align-items-sm-center">
                <div class="col-lg-auto col-12 pl-0">
            ...
            <div class="row mx-0 mt-5 mb-4 mb-xl-5 align-items-sm-center">
                <div class="col-lg-auto col-12 pl-0">
                    <p class="bg-lblue font-eb font-18 py-2 pl-3 pl-md-5 pr-5 mb-0 rounded-right-xl shadow-sm"><img src="assets/images/Icon awesome-tags.png" class="align-bottom" width="35px">&nbsp;&nbsp;Browse By Tags</p>
                </div>
                {{-- <div class="col-lg-auto col-12 mt-3 mt-lg-0 pl-md-5 pl-lg-3 text-muted">
