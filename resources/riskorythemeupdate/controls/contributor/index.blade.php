...
<div class="card shadow mb-4">
    ...
    <h6 class="m-0 font-weight-bold text-primary d-inline-block">Datatable of users.</h6>
    <a href="{{route('contributor.unverified')}}" class="btn btn-outline-danger btn-sm ">Unverified email</a>
            ...
            <form action="{{route('change.status.user',$con)}}" method="POST">
              ...
              @method('PUT')
                <div class="row mt-2">
                  ...
                  <div class="col-2 ">
                    <button class="btn btn-success" type="submit"><i class="fas fa-arrow-right"></i></button>
                  </div>
