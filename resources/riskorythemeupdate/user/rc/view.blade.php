...
<div class="pl-0 col-12 col-md-9 py-5 pr-0 pr-md-5">
    ...
    <div class="row pt-4">
        <div class="pl-0 col-12 col-sm-12 col-md-6 col-lg-4">
            <div class="">
            <p class="bg-lblue font-eb font-18 py-2 px-5 rounded-right-xl"><i><img src="{{asset('assets/images/Mask Group 10@2x.png')}}" class="align-bottom" width="35px"></i>&nbsp;&nbsp;Risk Control Detail</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 bg-lgray br-20 border-0 box-shadow mb-4">
            ...
            <div class="px-md-4 px-1 pt-5">
                ...
                <div class="col-12">
                    ...
                    <p class="p-style">{{$rc->objective}}</p>
