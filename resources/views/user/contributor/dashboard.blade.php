...
@section('content')
        ...
        <div class="pl-0 col-12 col-md-9 py-5 pr-0 pr-md-3 pr-lg-5">
            ...
            <div class="sect--title pl-3 pl-md-5">
                <div class="row my-4 my-xl-5 align-items-lg-center">
                    <div class="col-lg-auto col-12 px-0 pr-lg-3 order-xl-1 sect--title__col">
                        <p class="bg-lblue font-eb d-sm-inline-block font-18 ml-3 py-2 pl-4 pl-md-5 pr-5 mb-0 rounded-right-xl shadow-sm"><img src="assets/images/Icon awesome-tags.png" class="align-bottom" width="35px">&nbsp;&nbsp;Browse By Tags</p>
                    </div>
                    {{-- <div class="col-lg-auto col-12 text-muted order-xl-2">
                        <small class="d-block py-3 px-2"><i class="fas fa-info-circle pr-2"></i><span >So this is disclaimer here</span></small>
                    </div> --}}
